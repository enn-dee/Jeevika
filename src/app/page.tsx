    ...
    <main className="min-h-screen bg-gradient-to-br from-green-50 to-white text-gray-800">
      ...
      <section className="flex flex-col items-center justify-center text-center px-4 pt-20 pb-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          ...
          <Link
            href="/post"
            className="bg-white hover:bg-gray-100 border border-gray-300 px-6 py-3 rounded-lg flex items-center gap-2 shadow-sm"
          >
            <Hammer size={20} />
            Post Your Service
          </Link>
      ...
      <section className="bg-white py-10 px-6">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            <div key={title} className="bg-gray-50 p-5 rounded-md shadow hover:shadow-lg transition">
      ...
      <section className="py-12 bg-gradient-to-r from-green-100 to-green-50 px-6 text-center">
        <h2 className="text-2xl font-bold mb-2">Are You a Worker?</h2>
        <p className="text-gray-700 mb-6">Join now and get discovered by people looking for your skills.</p>
        <Link
          href="/auth/signup"
